...
const BenefitsTiles = () => {
  ...
  return <section ref={sectionRef} className="min-h-screen py-20 bg-gradient-to-b from-background via-card/20 to-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-16">
          ...
          <div className="scroll-text opacity-0 transform translate-y-12 transition-all duration-1000">
            <div className="mb-6">
              <h3 className="text-2xl md:text-3xl font-semibold text-muted-foreground mb-4">The Productivity</h3>
              <p className="text-3xl md:text-5xl font-bold leading-tight">
          ...
          <div className="scroll-text opacity-0 transform translate-y-12 transition-all duration-1000">
            <div className="mb-6">
              <h3 className="text-2xl md:text-3xl font-semibold text-muted-foreground mb-4">The Time</h3>
              <p className="text-3xl md:text-5xl font-bold leading-tight">
                We're creating
